...
VALUES ('2020-01-30 10:00:00', 'Завтрак', 500, 100000),
       ...
       ('2020-01-31 23:59:10', 'Еда на граничное значение', 100, 100000),
       ('2020-01-31 10:00:00', 'Завтрак', 1000, 100000),
       ('2020-01-31 13:00:00', 'Обед', 500, 100000),
       ('2020-01-31 20:00:00', 'Ужин', 410, 100000),
       ('2020-01-30 10:00:00', 'Завтрак', 437, 100001),
       ('2020-01-30 13:00:00', 'Обед', 1300, 100001),
       ('2020-01-30 20:00:00', 'Ужин', 250, 100001);