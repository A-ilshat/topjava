    ...
    <div class="container">
        <section>
            ...
            <div class="container border border-secondary rounded">
                ...
                <div class="row pb-3">
                    <div class="col">
                        <button onclick="resetFilter()" class="btn btn-warning btn-sm pull-left"><spring:message code="meal.filterReset"/></button>
                        <button onclick="getBetween()" class="btn btn-success btn-sm pull-right"><spring:message code="meal.filter"/></button>
                    </div>
                </div>
            </div>
            <br>
