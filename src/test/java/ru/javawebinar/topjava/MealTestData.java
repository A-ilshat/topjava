...
public class MealTestData {
    ...
    public static final MatcherFactory.Matcher<MealTo> MEALTO_MATCHER = MatcherFactory.matcher(MealTo.class);

    public static final int NOT_FOUND = 10;
    public static final int MEAL1_ID = START_SEQ + 3;
    public static final int ADMIN_MEAL_ID = START_SEQ + 10;
    public static final int USER_CALORIES = user.getCaloriesPerDay();
